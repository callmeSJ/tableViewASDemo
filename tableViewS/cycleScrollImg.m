...
@interface cycleScrollImg()<UIScrollViewDelegate>
...
-(void)createScroller{
    ...
    _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(140, height-30, 80, 20)];
